export async function init_iconButton2(parentElement, iconButtonClasses, iconButtonID, iconButtonIcon, iconButtonHandler, insertBefore = false, logConsole = false, logError = false) {
